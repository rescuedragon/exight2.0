            ...
            {actionLogs.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-20 text-center">
                ...
                <p className="text-muted-foreground text-lg max-w-md">
                  All your actions like adding expenses, making payments, and updates will be logged
                  ...
                  {actionLogs.map((log, index) => (
                    ...
                    >
                      ...
                      <TableCell className="py-4 px-4">
                        <span
                          className={`px-3 py-1 border rounded-full text-xs font-medium ${getActionColor(log.type)}`}
                        >
