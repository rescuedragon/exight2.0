      ...
      <div className="ml-12 mr-4 h-full relative">
        ...
        {hoveredIndex !== null &&
          (() => {
            ...
            const yPercent =
              maxAmount > 0 ? 100 - (data[hoveredIndex].amount / maxAmount) * 100 : 50;
                ...
                <div className="space-y-3">
                  <div className="border-b border-gray-200 dark:border-gray-600 pb-2">
                    <h4 className="font-bold text-gray-900 dark:text-white text-lg">
                      {data[hoveredIndex].month} {selectedYear}
                    </h4>
                  ...
                  <div className="space-y-2">
                    ...
                    {data[hoveredIndex].expenses.length > 0 ? (
                      data[hoveredIndex].expenses.map((expense, idx) => (
                        <div
                          key={idx}
                          className="flex justify-between items-center text-sm p-2 rounded-lg bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors"
                        >
                          <div>
