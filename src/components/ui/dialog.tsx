...
>(({ className, ...props }, ref) => {
  ...
  return (
    <DialogPrimitive.Overlay
      ref={ref}
      className={cn(
        // Softer, theme-aware overlay for better readability in light mode
        'fixed inset-0 z-[9999] backdrop-blur-[6px] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 bg-black/40 dark:bg-black/80',
        className,
      )}
      {...props}
    />
